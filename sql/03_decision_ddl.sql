...
GRANT SELECT ON ALL VIEWS IN SCHEMA DECISION TO ROLE TIDE_CUSTOMER;
GRANT SELECT ON ALL VIEWS IN SCHEMA DECISION TO ROLE TIDE_APPROVER;
GRANT SELECT ON ALL VIEWS IN SCHEMA DECISION TO ROLE TIDE_ESCALATION;

GRANT SELECT ON FUTURE VIEWS IN SCHEMA DECISION TO ROLE TIDE_CUSTOMER;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA DECISION TO ROLE TIDE_APPROVER;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA DECISION TO ROLE TIDE_ESCALATION;
