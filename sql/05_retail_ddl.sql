...
GRANT SELECT ON FUTURE VIEWS IN SCHEMA RETAIL TO ROLE TIDE_CUSTOMER;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA RETAIL TO ROLE TIDE_APPROVER;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA RETAIL TO ROLE TIDE_ESCALATION;
